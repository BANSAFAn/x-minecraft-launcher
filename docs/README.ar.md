...
Установка через HomeBrew также доступна через tap
...
Для разработчика локализации i18n, пожалуйста, следуйте [Начало работы с локализацией](https://docs.xmcl.app/en/guide/i18n)
## ЛИЦЕНЗИЯ
