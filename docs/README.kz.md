...
<p align="center">
  <a href="https://github.com/Voxelum/x-minecraft-launcher">
    <img src="https://github.com/Voxelum/x-minecraft-launcher/workflows/Build/badge.svg" alt="Жинау">
  </a>
...
![басты бет](https://raw.githubusercontent.com/Voxelum/xmcl-page/master/.vitepress/theme/assets/home.png)

Қолданбаны жүктеу үшін [официалды сайтты](https://xmcl.app) шолыңыз!

Егер сізде winget орнатылса, оны пайдаланып орнатуға болады

```bash
winget install CI010.XMinecraftLauncher
```

HomeBrew арқылы орнату да тапсырылатын болады
...
<kbd>[<img title="Араб" alt="Араб" src="https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fkolizej.at.ua%2F_pu%2F3%2F76583687.png&f=1&nofb=1&ipt=c6c2d418c48381f3f77a90574f99672f12cd72fe0ee90e89ade34438149f21aa" width="26">](docs/README.kz.md)</kbd>
...
- 📥 **Жүктеу және автоматты түрде аяқтау**. Официалды немесе үшінші жақтан жүктеу үшін `Minecraft`, `Forge`, `Fabric`, `Quilt`, `OptiFine`, `JVM` қолдау етіледі.
- ⚡️ **Жылдам жүктеу**. HTTP/HTTPS агенттер арқылы сокетті қайта пайдалану, және файлдарды бөліктермен параллельді түрде жүктеп алу.
- 💻 **Көп платформалық**. Лаунчер Electron негізінде жасалған, және 🗔 Windows 10/11, 🍎 MacOS және 🐧 Linux қолдау етеді.
- 📚 **Көп инстанциялар**. Пайдаланушылар әр түрлі нұсқалар, модтар және жөнелту параметрлерін бөлек қылып жасау үшін көптеген инстанциялар жасай алады.
- 🗂 **Барлық ресурстарды басқару**. Инстанцияларға ресурстарды орнату үшін (қатынас/символдық) сілтемелерді пайдаланыңыз, дисктің пайдалануын оптималды сақтаңыз. Модтардың бәрінде көшірмелер жоқ! 😆
- 🔥 **CurseForge, Modrinth қолдауы**. Лаунчер ішінде ресурстарды жүктеуге болады.
- 📦 **Импорт/экспорт қолдауы** CurseForge және Modrinth модпактарын сәйкестендіру!
- 🔒 **Бірнеше аккаунт жүйелерін қолдау**. Ішкі Microsoft кіру және Mojang Yggdrasil API. Ол [ely.by](https://ely.by/) және [littleskin.cn](https://littleskin.cn) үшін де ішкі қолдау бар. Үшінші жақ авторизация серверлерін қосуға болады!
- 🔗 **Пайдаланушылар арасында P2P байланыс**. Егер сіз физикалық LAN-да болмасаңыз да, LAN арқылы көп ойын ойлауға болады!
- 🔑 **Кодты белгілеу және жаңа пакеттеу**. Windows-та `appx` және `appinstaller` арқылы қолданбаны орнатуға болады. Браузеріңізден және SmartScreen қателерінен қайта блокталмаған жағдайда болады! 😎

## Қосылыңыз

[![DeepWiki сұрауы](https://deepwiki.com/badge.svg)](https://deepwiki.com/Voxelum/x-minecraft-launcher)

Жалпы дамытушы үшін, [Қосылу](./CONTRIBUTING.md) қараңыз

i18n локализациясы үшін, [Локализация бойынша бастау](https://docs.xmcl.app/en/guide/i18n) бағдарламасын қолданыңыз
...
| [![](https://github.com/DGP-Studio/Snap.Hutao/assets/10614984/73ae8b90-f3c7-4033-b2b7-f4126331ce66)](https://signpath.io/) | Windows-тағы кодты белгілеудің тегін қызметі [SignPath.io](https://signpath.io/) арқылы, сертификат [SignPath Foundation](https://signpath.org/) жағынан беріледі |
| :----------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy), XMCL серверлік JavaScript қолданбалары үшін қолданылатын қолайлы платформасын қолданады. [Deno](https://deno.com/) қызметінен беріледі |
| [![](assets/EdgeOne.png)](https://edgeone.ai/) | [Ең жақсы Азия CDN, Edge және қорғаныс шешімдері - Tencent EdgeOne](https://edgeone.ai/), бұл жоба үшін CDN жылдамдылығын және қорғанысын қамтамасыз ететін Tencent EdgeOne спонсоры |
...
[BANER](https://github.com/BANSAFAn), RU/UK қоғамдастығында маған көп көмектескен.

[GodLeaveMe](https://github.com/GodLeaveMe), [v1mkss](https://github.com/v1mkss), AUR десте жинақтауын сақтаған.

[0xc0000142](https://github.com/0xc0000142), winget дестесін сақтаған.

[Marmur2020](https://github.com/Marmur2020) & [BANSAFAn](https://github.com/BANSAFAn), украин тілін толығымен аударған!

[vanja-san](https://github.com/vanja-san), рус тілін ұсынған!

[lukechu10](https://github.com/lukechu10) & [HoldYourWaffle](https://github.com/HoldYourWaffle) маған лаунчер ядросында көмектесті.

[laolarou726](https://github.com/laolarou726), лаунчер дизайнінде маған көмектесті.

Сондай-ақ, маған арналған құрметіміз
